...
const Card: FC<{
  ...
  return (
    ...
    >
      ...
      <span
        className={cn(
          "x:flex x:w-full x:items-center x:justify-between x:gap-2 x:p-4 x:font-semibold x:text-gray-700 x:hover:text-gray-900",
          arrow && [
            // Tambahkan x:ml-auto agar arrow tetap di kanan meskipun teks membungkus
            'x:after:content-["→"] x:after:transition-transform x:after:duration-75 x:after:ml-auto x:after:pl-2',
