...
export default function Home() {
  return (
    <div className="flex min-h-[calc(100vh-var(--nextra-navbar-height))] justify-center overflow-hidden bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 pt-24 md:pt-32 pb-20">
      <main className="flex flex-col items-center space-y-4 text-center lg:items-start lg:text-left max-w-5xl w-full">
        {/* Badge */}
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 pt-6 w-full sm:w-auto">
          ...
          <Button
            asChild
            size="lg"
            className="w-48 sm:w-auto rounded-full font-bold bg-blue-600 text-white shadow-lg shadow-blue-500/20 hover:bg-blue-500 hover:shadow-blue-500/30"
          >
            <Link
