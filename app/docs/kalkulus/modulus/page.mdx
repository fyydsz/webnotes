...
| Sifat | Rumus |
|-------|-------|
| Non-negatif | <Latex>{`\|z\| \\geq 0`}</Latex> |
| Perkalian | <Latex>{`\|z_1 \\cdot z_2\| = \|z_1\| \\cdot \|z_2\|`}</Latex> |
| Pembagian | <Latex>{`\\left\|\\frac{z_1}{z_2}\\right\| = \\frac{\|z_1\|}{\|z_2\|}`}</Latex> |
| Konjugat | <Latex>{`\|z\| = \|\\bar{z}\|`}</Latex> |
| Segitiga | <Latex>{`\|z_1 + z_2\| \\leq \|z_1\| + \|z_2\|`}</Latex> |
...
| Rumus | Keterangan |
|-------|------------|
| <Latex>{`\|z\| = \\sqrt{x^2 + y^2}`}</Latex> | Modulus bilangan kompleks <Latex>{`z = x + yi`}</Latex> |
| <Latex>{`\|z_1 \\cdot z_2\| = \|z_1\| \\cdot \|z_2\|`}</Latex> | Sifat perkalian |
| <Latex>{`\\left\|\\frac{z_1}{z_2}\\right\| = \\frac{\|z_1\|}{\|z_2\|}`}</Latex> | Sifat pembagian |
